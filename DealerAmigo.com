...
<body>
    <header>
        <div class="container">
            <div class="header-content">
                ...
                <a href="tel:+17875301101" class="cta-button">📞 Llamar Ahora</a>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            ...
            <div class="packages-grid">
                <div class="package-card">
                    ...
                    <a href="https://docs.google.com/forms/d/1H5ElRfHZ2vWOj6lR02jG5Ijp57GG4pteHMHmbtU4epM/viewform" class="cta-button">Elegir Plan</a>
                </div>
    ...
    <section class="cta">
        <div class="container">
            ...
            <div class="flex justify-center space-x-4">
                <a href="https://calendly.com/autoamigo" class="bg-white text-violet-800 font-bold py-3 px-6 rounded-2xl shadow-lg hover:bg-violet-100 transition">Agendar llamada</a>
    ...
    <footer id="contacto">
        <div class="container">
            ...
            <a href="https://calendly.com/autoamigo" class="cta-button" style="margin-right: 20px;">📞 Agenda una Llamada</a>
    ...
    <a href="tel:+17875301101" class="floating-whatsapp" title="Llamar al 787-530-1101">
        📞
    </a>
